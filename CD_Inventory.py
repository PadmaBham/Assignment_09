...
# PBhamidipati, 2022-Dec-11, Updated docstrings & code to address all TODOs and 
#    instructions for Assignment 9 (Mod09_B); added sub menu to extend functionality for CD Tracks
#------------------------------------------#
    ...
    if strChoice == 'l':
        ...
        while True:
            ...
            if strSubChoice == "x":
                ...
                try:
                    track_position_to_remove = IO.ScreenIO.get_track_to_remove(cd)
                    PC.DataProcessor.remove_track(int(track_position_to_remove), cd)
                except ValueError as e:
                    print("The Track Position must be an integer!", e, e.__doc__)
            else:
                continue
